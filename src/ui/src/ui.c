...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Header_Time, "PM 16:33");
    ...
    lv_obj_set_width(ui_Label_Celsius, 79);
    lv_obj_set_height(ui_Label_Celsius, LV_SIZE_CONTENT);    /// 20
    lv_obj_set_x(ui_Label_Celsius, 12);
    ...
    lv_label_set_text(ui_Label_Slider, "free heap ");
